                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="grid gap-1 items-start">
                                        ...
                                        <div className="text-sm text-gray-500 dark:text-gray-400">Algebra and Geometry</div>
                                    </div>
                                </div>
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="grid gap-1 items-start">
                                        ...
                                        <div className="text-sm text-gray-500 dark:text-gray-400">Cellular and Molecular Biology</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2 mt-4">
                                    <div className="flex items-center gap-1 px-2 h-7 rounded-full bg-blue-100 border-blue-400 border-2">
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="grid gap-1 items-start">
                                        ...
                                        <div className="text-sm text-gray-500 dark:text-gray-400">Mechanics and Electromagnetism</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2 mt-4">
                                    <div className="flex items-center gap-1 px-2 h-7 rounded-full bg-blue-100 border-blue-400 border-2">
